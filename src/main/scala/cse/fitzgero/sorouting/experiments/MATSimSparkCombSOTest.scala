...
object MATSimSparkCombSOTest extends Experiment with MATSimSimulator {
...
//    sparkMaster: String,
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sparkConf = new SparkConf().setAppName("MATSimSparkCombSOTest").setMaster(sparkMaster)
