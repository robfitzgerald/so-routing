...
import cse.fitzgero.sorouting.algorithm.local.routing.KSPSparkCombinatorialRoutingService
...
object SparkCombinationsSORouting {
  ...
  object Incremental extends SyncStep {
    ...
    protected def incrementalLoopLocal(testGroup: GenSeq[LocalRequest], controlGroup: GenSeq[LocalRequest], currentInstanceDirectory: String, timeWindow: Int, kspConfig: KSPLocalDijkstrasConfig, sparkContext: SparkContext)
