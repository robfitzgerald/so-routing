...
import cse.fitzgero.sorouting.experiments.steps.{ExperimentAssetGenerator, Reporting, SystemOptimalMCTSRouting, SystemOptimalMCTSRouting02}
...
object MATSimSO_MCTS02Test extends Experiment with App with MATSimSimulator {
...
//    coefficientCp = 0D, // finds a solution if possible in most situations, best for our case (flat monte carlo, yes?)
  ...
  runSync(config, List(
    ...
    SystemOptimalMCTSRouting02.Incremental,
