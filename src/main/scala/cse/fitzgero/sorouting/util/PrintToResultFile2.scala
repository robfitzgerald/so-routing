...
case class PrintToResultFile2 (
  ...
  combinations: Int,
  hasAlternates: Int,
  expectedUECostEffect: Int,
  expectedSOCostEffect: Int,
  popAvgTripUE: Double,
  ...
  override def toString: String = {
    ...
    f"$populationSize,$totRouteRequests,$ueRouteRequests,$soRouteRequests,$routePercent%%,$windowDur,$combinations,$hasAlternates,$expectedUECostEffect,$expectedSOCostEffect,$popAvgTripUE%.3f,$popAvgTripUESO%.3f,$netAvgTripUE%.3f,$netAvgTripUESO%.3f,$popTravelTimeImprovement%.4f,$netTravelTimeImprovement%.4f"
  }
}

object PrintToResultFile2 {
  def resultFileHeader: String = "populationSize,totalRouteRequests,routeRequestsUE,routeRequestsSO,routePercent,windowDuration,combinations,hasAlternates,expectedUECostEffect,expectedSOCostEffect,popAvgTripUE,popAvgTripUESO,netAvgTripUE,netAvgTripUESO,popTravelTimeImprovement,netTravelTimeImprovement"
}
